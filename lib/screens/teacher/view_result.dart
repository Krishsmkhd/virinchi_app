...
class _AssignmentPageState extends State<ViewResult> {
  ...
  getMarks(String id) async {
    ...
    await FirebaseFirestore.instance
      ...
      for (var item in value.docs) {
        if (item["subject"] == _selectedSubject) {
          setState(() {
              ...
              Visibility(
                ...
                child: Column(
                  children: [
                    ...
                    const Text('Marks', style: TextStyle(fontSize: 20)),
                    const SizedBox(height: 18),
                    Text(marks, style: const TextStyle(fontSize: 20)),
                  ],
                ),
              ),
            ],
